...
virtualenv
Доступен в пакетеpython-virtualenv.
$ virtualenvenvname
Активация
...
(envname) $ deactivate
Версии Python
По умолчанию виртуальные окружения создаются с использованием стандартного системногоPython. Файлbin/pythonэто просто символическая ссылка на системный python:
