...
![img1.jpg](:/f1388ec8eee64bbd96a7925b84507997)
...
![img2.png](:/312d3af85c3f4c3cb9ecfed9fe38f183)
Рисунок 2 – Терминал с результатом работы команды echo %PATH%


![img3.png](:/e8d9e9bf16b64db897f1da09fd2fb6a0)
...
Рассмотрим содержимое переменной окружения PATH в Linux, а также внесем в неё временные и постоянные изменения.
...
Чтобы добавить директорию на непостоянной основе - пропишите её в .bashrc
...
Чтобы создать виртуальную среду, мы используем модуль venv. Это удобный инструмент для управления зависимостями и изоляции проектов, который выстроен в Python, начиная с версии Python 3.3+. Поэтому модуль venv нельзя использовать для изоляции программ Python.
...
Как мы видим, внутри виртуальной среды у нас нет никаких сторонних установленных библиотек pip. Можно установить какой-либо пакет, например, модуль `requests`:
...
Утилита virtualenv - это наиболее популярный инструмент, который используется для создания изолированных сред Python. Он создает папку, содержащую все необходимые исполняемые файлы для использования пакетов, которые потребуются проекту Python. В отличие от модуля venv, эту утилиту можно использовать как в Python 3, так и в версии 2.7.
...
new-project
Выводы
Вы познакомились с основами работы с виртуальными средами в Python. И теперь знаете про особенности установки и использования утилит venv, virtualenv и virtualenvwrapper в Python.
...
## Task: Set up a virtual environment using venv to manage project dependencies
...
**`python -m venv myenv`**
- Activate the virtual environment using the following command (Windows): **`myenv\Scripts\activate.bat`** or (Linux/MacOS): 
**`source myenv/bin/activate`**
- Install the project dependencies using pip:
**`pip install -r requirements.txt`**
- Verify that the virtual environment is working correctly by running the project or its tests within the activated environment
- When finished working on the project, deactivate the virtual environment using the command deactivate
- By using venv, you can create a self-contained environment that isolates the dependencies for your project from the system-wide Python installation, making it easier to manage and maintain your project's dependencies.
...
- Create a new virtual environment using the following command: 
**`python -m venv myenv`**
- Activate the virtual environment using the following command (Windows): **`myenv\Scripts\activate.bat`** or (Linux/MacOS): **`source myenv/bin/activate`**
- Install the project dependencies using pip: 
**`pip install -r requirements.txt`**
- Verify that the virtual environment is working correctly by running the project or its tests within the activated environment
- When finished working on the project, deactivate the virtual environment using the command deactivate
...
- Create a new virtual environment using the following command: 
**`python -m venv venv`**
- Activate the virtual environment using the following command (Windows): **`venv\Scripts\activate.bat`** or (Linux/MacOS): **`source venv/bin/activate`**
- Install the project dependencies using pip: 
**`pip install -r requirements.txt`**
- Verify that the virtual environment is working correctly by running the project or its tests within the activated environment
- When finished working on the project, deactivate the virtual environment using the command deactivate
...
## Task: Set up a virtual environment using venv and push code to a GitHub repository

Steps:

- Create a new repository on GitHub for your project
- Clone the repository to your local machine using the **`git clone`** command
- Navigate to the root directory of your project in the terminal or command prompt
- Create a new virtual environment using the following command: **`python -m venv venv`**
- Activate the virtual environment using the following command (Windows): **`venv\Scripts\activate.bat`** or (Linux/MacOS): **`source venv/bin/activate`**
- Install the project dependencies using pip: **`pip install -r requirements.txt`**
- Write your code and commit changes using **`git add .`** and **`git commit -m "Commit message"`**
- Push your changes to the GitHub repository using **`git push`**
- When finished working on the project, deactivate the virtual environment using the command deactivate
- To use the project on another machine, clone the repository and repeat steps 4-6 to set up the virtual environment and install dependencies.
- By using venv and GitHub together, you can isolate your project dependencies and easily collaborate with others on your project.


## Task: Set up a virtual environment using venv and push code to a Git repository
...
- Install the project dependencies using pip: **`pip install -r requirements.txt`**
- Write your code and commit changes using **`git add .`** and **`git commit -m "Commit message"`**
- Push your changes to the Git repository using **`git push`**
- When finished working on the project, deactivate the virtual environment using the command deactivate
- To use the project on another machine, clone the repository and repeat steps 4-6 to set up the virtual environment and install dependencies.
By using venv and Git together, you can isolate your project dependencies and easily track changes to your code over time.
