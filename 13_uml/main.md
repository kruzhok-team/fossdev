...
Вот пример использования диаграммы последовательности для описания процесса  «Заугрузки мобильного приложения» используя маркетплейс (store) мобильных приложений:
...
2. Ограниченная возможность повторного использования: диаграммы UML нельзя использовать повторно, поскольку их может потребоваться обновлять и изменять по мере развития требований и дизайна системы.
