...
Есть также альтернативно оформление, которое на мой взгляд при условии использования отступов выглядит более приятно. Уточните какой из эти способов принят в команде к которой вы подключаетесь. Но скобки должны быть
